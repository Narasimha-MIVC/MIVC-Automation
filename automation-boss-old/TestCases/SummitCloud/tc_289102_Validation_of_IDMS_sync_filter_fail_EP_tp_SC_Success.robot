*** Settings ***
Documentation    Validation of idms  sync SC with Filter as failed -
...
*** Test Cases ***
Validation of idms sync SC with Filter as failed - Success of EventPropagator-eventpropagator to SC Success
       [Tags]    DEBUG
