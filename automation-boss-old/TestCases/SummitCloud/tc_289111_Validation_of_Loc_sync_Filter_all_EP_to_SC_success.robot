...
*** Test Cases ***
Validation of loc sync SC with Filter as all - Success of EventPropagator-eventpropagator to SC Success
    ...
    @{data_uc_back_sync}=  I fetch data from back sync db  &{url_info1}
