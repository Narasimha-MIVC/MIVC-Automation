*** Settings ***
Documentation    Edited Assigned TN from Bridged Call Appearance to Unassign as PM user
...
*** Test Cases ***
Login as PM user and Edit Assigned TN from Bridged Call Appearance to Unassign
