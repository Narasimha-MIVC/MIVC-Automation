*** Settings ***
Documentation     MH15_single_clicks_on_contact_in_system_directory_open_contact_card
...               Bhupendra Parihar
...
*** Test cases ***
MH15_single_clicks_on_contact_in_system_directory_open_contact_card
    ...
    # Search user2 in quick dialer
    Search People Extension with ${client1} and ${user02.first_name} ${user02.last_name}

    Click First Visible Result In Search with ${client1}
