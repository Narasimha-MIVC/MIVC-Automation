*** Settings ***
Documentation     MH_BargeIn_Muted_Call
...               Aakash
...               Comments:
...
MH_BargeIn_Muted_Call 
    ...
    # UserB mutes the call
    Place End Call with ${client2} and mute and ${EMPTY}
    
    # UserC opens contact card of UserA
    Search People Extension with ${client3} and ${user01.first_name} ${user01.last_name} 
    #Sleep       1s
    # UserC Barge In to the call between UserA and UserB
    Click Barge Call In Client with ${client3} and enable
    Sleep       2s
    
    # Verify that after Barge In there is a conference call in all the three clients
    ...
    #Verify Users In A Dashboard In Call with ${client3} and two_users and connectauto2 and connectauto1
    
    # UserB unmutes the call
    Place End Call with ${client2} and unmute and ${EMPTY}    
