*** Settings ***
Documentation    Validation of loc sync SC with Filter as all- Failure of EventPropagator
...
*** Test Cases ***
Validation of loc sync SC with Filter as all- Failure of EventPropagator
