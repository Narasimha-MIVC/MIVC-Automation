*** Settings ***
Documentation    Validation of tds sync SC with Filter as failed - Success of EventPropagator-
...
*** Test Cases ***
Validation of tds sync SC with Filter as failed - Success of EventPropagator-eventpropagator to SC Fails
