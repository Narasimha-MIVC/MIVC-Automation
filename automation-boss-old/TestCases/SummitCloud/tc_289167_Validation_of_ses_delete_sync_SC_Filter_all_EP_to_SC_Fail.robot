*** Settings ***
Documentation    Validation of ses delete sync SC with Filter as all - Success of EventPropagator-
...
*** Test Cases ***
Validation of ses delete sync SC with Filter as all - Success of EventPropagator-eventpropagator to SC Failed
