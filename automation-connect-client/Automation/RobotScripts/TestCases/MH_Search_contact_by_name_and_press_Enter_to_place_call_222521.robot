*** Settings ***
Documentation     MH_Search_contact_by_name_and_press_Enter_to_place_call
...               Aakash
...               Comments:
...
*** Test Cases ***
MH_Search_contact_by_name_and_press_Enter_to_place_call       
    ...
    Search People For Multiuser with ${client1} and ${user02.first_name} ${user02.last_name}
    ...
    Place End Call with ${client1} and enter and ${EMPTY}
    ...
    # UserB verifies that in client pane caller name is present with number of calls = 1
    Check Client Panel with ${client2} and ${user01.first_name} ${user01.last_name} and onCall and 1 and ${EMPTY}
    # UserA verifies that in client pane callee name is present with number of calls = 1
    ...
    # UserA again opens contact card of UserB
    Search People Extension with ${client2} and ${user01.first_name} ${user01.last_name}
    #Sleep       4s
    
    # Check conncetauto2 conversation pane
