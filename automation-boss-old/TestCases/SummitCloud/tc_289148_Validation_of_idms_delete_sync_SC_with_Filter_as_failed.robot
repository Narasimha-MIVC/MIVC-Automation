...
...             Success of EventPropagator-eventpropagator to SC Success
...
*** Test Cases ***
API to expose Event data - Validation of idms delete sync SC with Filter as failed - Success of EventPropagator-eventpropagator to SC Success
    [Tags]    DEBUG
