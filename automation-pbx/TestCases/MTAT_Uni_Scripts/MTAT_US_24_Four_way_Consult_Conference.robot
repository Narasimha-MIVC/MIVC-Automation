*** Settings ***
Documentation     Four way Consult Conference
...
Four way Consult Conference
    ...
    accept consult conference from ${Phone01}
    BuiltIn.sleep   10s
    ...
    Log          STEP - 7: Click on Consult Conference and Add Phone04
    make conference from ${Phone01}
    BuiltIn.sleep   1s
    ...
    Log          STEP - 10: Click on Consult Conference and Add Phone05
    make conference from ${Phone01}
    BuiltIn.sleep   1s
    Using ${Phone01} I dial the digits ${Phone05.phone_obj.phone.extensionNumber}
    BuiltIn.sleep   5s
    consult conference from ${Phone01}
    BuiltIn.sleep   5s

    Log          STEP - 12: Phone05 Answer the call
    answer the incoming call on ${Phone05}
    BuiltIn.sleep   5s

    accept consult conference from ${Phone01}
    BuiltIn.sleep   10s

    Log          STEP - 13: Verify the 2 way consult conference
    verify ${Phone01} on display of Conferenced 4 calls
    ...
    verify ${Phone05} on display of Conferenced 4 calls
    BuiltIn.sleep   1s

    Log          STEP - 14: Phone01 End the call
    disconnect the call from ${Phone01}
    BuiltIn.sleep   2s

    Log          STEP - 15: Phone02 End the call
    disconnect the call from ${Phone02}
    BuiltIn.sleep   2s

    Log          STEP - 16: Phone01 End the call
    disconnect the call from ${Phone03}
    BuiltIn.sleep   2s

    Log          STEP - 17: Phone02 End the call
