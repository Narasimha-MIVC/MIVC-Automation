...
*** Test Cases ***
1.Create Non-User Profile(BCA) without DID in D2 test case
    [Tags]    DEBUG
    ...
    #7. Delete Non-profile user and STD2 user(STD2 user should be delete after BCA user deletion)
