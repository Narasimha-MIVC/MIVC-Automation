*** Settings ***
Documentation     Login to BOSS portal as DM user and Validate allignment of Settings field for AA menu
...               Priyanka M
...               Comments:
...
*** Test Cases ***
01 Login to the boss portal as DM user and verify Allignment of Settings field
