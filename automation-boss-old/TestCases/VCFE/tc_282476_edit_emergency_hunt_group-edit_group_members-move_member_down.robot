*** Settings ***
Documentation     Login to BOSS portal and edit emergency Hunt group and check the functionality of up arrow and
...
Library  String
*** Test Cases ***
Edit Emergency Hunt Group and check functionality of up arrow and down arrow button with DM User
...
#    when I switch to "Visual_Call_Flow_Editor" page
    ...
    ${extn}    ${location}=    Then I create emergency hunt group  &{EmergencyHuntGroup2}
    And I select vcfe component by searching extension "${extn}"
    set to dictionary  ${EmergencyHG_Edit2}     grp_member   ${extn_num}
    set to dictionary  ${EmergencyHG_Edit2}  Distribution_pattern     Top_down
    set to dictionary  ${EmergencyHG_Edit2}   verify_up_down_button     down
    Then I edit emergency hunt group    &{EmergencyHG_Edit2}
...
Edit Emergency Hunt Group and check functionality of up arrow and down arrow button with PM User
    [Tags]    Regression    EHG
...
Edit Emergency Hunt Group and check functionality of up arrow and down arrow button with Staff User
    [Tags]    Regression    EHG
