*** Settings ***
Documentation    Create Account in BOSS to push to UC-TDS - Add Account through connect
...              Author: Priyanka M
...
Add account through connect
    ...
    Then I open login page with ${URL_connect}
    And I add account using connect    &{TestContract}
