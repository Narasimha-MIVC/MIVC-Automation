*** Settings ***
Documentation    Validation of ses delete sync SC with Filter as failed - Success of EventPropagator-
...
*** Test Cases ***
Validation of ses delete sync SC with Filter as failed - Success of EventPropagator-eventpropagator to SC Failed
...
#    sleep   10
#    # fetch the data from UC SES and it should be empty as SES container is down DAta will not be pushed on SES DB -
