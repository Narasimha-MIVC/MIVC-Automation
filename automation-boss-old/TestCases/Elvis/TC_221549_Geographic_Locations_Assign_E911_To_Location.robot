...
Initialize Environment
    ...
    Set Suite Variable    ${register_ok}         ${values["register_ok"]}
...
221550 - Geographic Locations - Edit E911 phone number for location
    ...
    When I filter column headings for ${grid} with Name in ${register_ok}
    and I show the context menu for ${grid} with Name in ${register_ok}
    Then I can choose the update item from the grid context menu ${contextitems}
    and I click on "//*[@id='updateLocationRegistrationForm']/div/fieldset/div[3]/button/span" button/link
    and I Click On "//*[@id="fnMessageBox_OK"]/span" Button/link
    Then I can find Registered in the ${grid}
    When I show the context menu for ${grid} with Name in ${register_ok}
    and I can choose the update item from the grid context menu ${contextitems}
    and I click on "//*[@id='updateLocationRegistrationForm']/div/fieldset/div[3]/button/span" button/link
    and I Click On "//*[@id="fnMessageBox_OK"]/span" Button/link
    Then I can find Not Registered in the ${grid}
