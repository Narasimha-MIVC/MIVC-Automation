*** Settings ***
Documentation    Validation of ses sync SC with Filter as failed - Success of EventPropagator-
...
*** Test Cases ***
Validation of ses sync SC with Filter as failed - Success of EventPropagator-eventpropagator to SC Fails
