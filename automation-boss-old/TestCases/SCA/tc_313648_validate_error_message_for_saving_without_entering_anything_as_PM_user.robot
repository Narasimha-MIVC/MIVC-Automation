*** Settings ***
Documentation     Login to BOSS portal as PM user and Validate error message for saving without entering anything
#...               dev-Vasuja
#...               Comments:
...
Login as PM and Validate error message for saving without entering anything
