*** Settings ***
Documentation    As a staff user verify already assaigned profile should not list in abca profile drop down
...               dev-Vasuja
...
*** Test Cases ***
As a staff user verify already assaigned profile should not list in abca profile drop down
