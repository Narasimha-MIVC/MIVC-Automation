...
...               of EventPropagator - eventpropagator to SC Success
...
*** Test Cases ***
Validation of tds delete sync SC with Filter as failed - Success of EventPropagator - eventpropagator to SC Success
