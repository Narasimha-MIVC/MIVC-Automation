*** Settings ***
Documentation    Publish Service update to UC-SES - Account  level service update
...
*** Test Cases ***
Publish Service update to UC-SES - Account level service update
    ...
    set to dictionary  ${ADD_ON_FEATURE_2}  RequestedBy  ${request_user}

    # Activate the add on feature Connect_Call_Recording
    When I switch to "addonfeatures" page
    And I activate Add-On features  &{ADD_ON_FEATURE_2}
    sleep  2
...
Set Init Env
    ...
    Run keyword if    '${country}' == 'Australia'
            ...
            ...    AND set to dictionary  ${PhNumDetail}  &{PhoneNumber_AUS}


            ...    ELSE IF    '${country}' == 'UK'
            ...    Run Keywords
            ...    set to dictionary  ${TestContract}  &{Contract_UK}
            ...    AND  set to dictionary  ${PhNumDetail}  &{PhoneNumber_UK}


            ...    ELSE IF    '${country}' == 'US'
            ...    Run Keywords
            ...    set to dictionary  ${TestContract}   &{Contract_US}
            ...    AND    set to dictionary  ${PhNumDetail}  &{PhoneNumber_US}
    ...
    : FOR    ${key}    IN    @{PhNumDetail.keys()}
    \    ${updated_val}=    Replace String    ${PhNumDetail["${key}"]}    {rand_int}    ${uni_num}
    \    Set To Dictionary    ${PhNumDetail}    ${key}    ${updated_val}
    \    ${updated_val}=    Replace String    ${PhNumDetail["${key}"]}    {rand_str}    ${uni_str}
    \    Set To Dictionary    ${PhNumDetail}    ${key}    ${updated_val}
