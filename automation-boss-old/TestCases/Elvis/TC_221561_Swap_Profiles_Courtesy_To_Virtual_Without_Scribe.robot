...
Initialize Environment
    ...
    Set Suite Variable  ${courtesyProfile}   ${values["courtesyProfile"]}
...
*** Test Cases ***
TC_221561_Swap_Profiles_Courtesy_To_Virtual_Without_Scribe
    ...
    and I filter column headings for ${usersDataGrid} with BusinessEmail in ${courtesyProfile}
    and I show the context menu for ${usersDataGrid} with BusinessEmail in ${courtesyProfile}
    ...
    When I finish the ${ElvisSwapWizard} without confirmation
    and I filter column headings for ${usersDataGrid} with BusinessEmail in ${courtesyProfile}
    and I show the context menu for ${usersDataGrid} with BusinessEmail in ${courtesyProfile}
    and I can choose the swap item from the grid context menu ${usersDataGrid["contextitems"]}
