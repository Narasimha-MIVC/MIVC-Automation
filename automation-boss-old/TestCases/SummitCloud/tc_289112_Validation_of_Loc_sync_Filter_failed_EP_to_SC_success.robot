*** Settings ***
Documentation    Validation of loc sync SC with Filter as failed - Success of EventPropagator-
...
*** Test Cases ***
Validation of loc sync SC with Filter as failed - Success of EventPropagator-eventpropagator to SC Success
