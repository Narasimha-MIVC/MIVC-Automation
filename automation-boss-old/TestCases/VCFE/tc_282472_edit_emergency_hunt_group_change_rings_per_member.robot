*** Settings ***
Documentation     Login to BOSS portal and Edit Emergency Hunt Group - Change Rings per Member
#...               dev-Vasuja
#...               Comments:
...
1 Login as DM and Edit Emergency Hunt Group - Change Rings per Member
...
#    And I create geographic location    &{geolocationDetails}
    ...
    Set to Dictionary    ${EmergencyHG_Edit}    Rings_per_Member    90
...
2 Login as PM and Edit Emergency Hunt Group - Change Rings per Member
    [Tags]    Regression    EHG
...
3 Login as Staff user and Edit Emergency Hunt Group - Change Rings per Member
    [Tags]    Regression    EHG
