*** Settings ***
Documentation     MH_Transfer_Intercom_Extension_to_Extension
...               Bhupendra Parihar
...
*** Test cases ***
MH_Transfer_Intercom_Extension_to_Extension
    ...
    Add Participants For Park Call with ${client2} and park and ${user03.first_name} ${user03.last_name}
