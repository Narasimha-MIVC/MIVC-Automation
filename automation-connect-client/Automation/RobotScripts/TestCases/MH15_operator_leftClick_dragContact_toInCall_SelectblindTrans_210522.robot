*** Settings ***
Documentation     MH15_operator_leftClick_dragContact_toInCall_SelectblindTrans
...               HariPrakash
...
*** Test cases ***
MH15_operator_leftClick_dragContact_toInCall_SelectblindTrans
	...
	Place End Call with ${client1} and drag_and_move and BlindConference
	
	#UserC receives the calll from UserC
	...
	# UserB ends the call with UserB
