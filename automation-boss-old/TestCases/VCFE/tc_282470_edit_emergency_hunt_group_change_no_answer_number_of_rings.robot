*** Settings ***
Documentation     Login to BOSS portal and Edit Emergency Hunt Group - Change No Answer Number of Rings
#...               dev-Vasuja
#...               Comments:
...
1 Login as DM and Edit Emergency Hunt Group - Change No Answer Number of Rings
...
#    And I create geographic location    &{geolocationDetails}
    ...
    Set to Dictionary    ${EmergencyHG_Edit}    No_answer_number_of_rings    120
...
2 Login as PM and Edit Emergency Hunt Group - Change No Answer Number of Rings
    [Tags]    Regression    EHG
...
3 Login as Staff user and Edit Emergency Hunt Group - Change No Answer Number of Rings
    [Tags]    Regression    EHG
