*** Settings ***
Documentation    Validation of ses sync SC with Filter as Failed - Success of
...
*** Test Cases ***
Validation of ses sync SC with Filter as Failed - Success of EventPropagator-eventpropagator to SC Success
