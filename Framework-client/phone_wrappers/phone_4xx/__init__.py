...
class PPhoneInterface(object):
    ...
    def __init__(self):
        ...
        # TODO - remove robot dependencies
        ...
        self.pphoneutil_path = os.path.join(self.os_atf_path, 'utils','pphoneutil','phoneutil.exe')
        
        if self.is_mt is not "false":
            self.pphoneutil_hq_rsa = os.path.join(self.os_atf_path, 'utils','pphoneutil','rsa_keys','mt_hq_rsa')
        else:
            self.pphoneutil_hq_rsa = os.path.join(self.os_atf_path, 'utils','pphoneutil','rsa_keys','hq_rsa')
