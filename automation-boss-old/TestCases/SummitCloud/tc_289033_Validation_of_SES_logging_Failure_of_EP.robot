*** Settings ***
Documentation    Event Persistence - Validation of ses logging - Failure of EventPropagator
...
*** Test Cases ***
Event Persistence - Validation of ses logging - Failure of EventPropagator
