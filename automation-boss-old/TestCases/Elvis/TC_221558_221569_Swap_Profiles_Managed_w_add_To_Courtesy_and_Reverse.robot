...
Initialize Environment
    ...
    Set Suite Variable  ${ManagedWithAddProfile}   ${values["ManagedWithAddProfile"]}
...
*** Test Cases ***
TC_221569_Swap_Profiles_Managed_With_Add_To_Courtesy
    ...
    and I filter column headings for ${usersDataGrid} with BusinessEmail in ${ManagedWithAddProfile}
    and I show the context menu for ${usersDataGrid} with BusinessEmail in ${ManagedWithAddProfile}
...
TC_221558_Swap_Profiles_Courtesy_To_Managed_With_Add
    and I filter column headings for ${usersDataGrid} with BusinessEmail in ${ManagedWithAddProfile}
    When I show the context menu for ${usersDataGrid} with BusinessEmail in ${ManagedWithAddProfile}
    and I can choose the swap item from the grid context menu ${usersDataGrid["contextitems"]}
    And I fill in ${ElvisSwapWizard} form with ${swap_select_2}
