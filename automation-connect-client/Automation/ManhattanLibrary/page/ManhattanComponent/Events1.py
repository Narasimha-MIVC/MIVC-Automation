...
class Events:
    ...
    def share_call_screen(self, params, retry=True):
        """
        author:prashanth
        ...
        try:
            if "share" in params.keys():
                ...
                if params["share_option"] == "share_full_screen":
                    ...
                    time.sleep(6) # wait for choose application to share window to appear
                ...
                if params["role"] == "organizer":
                    ...
                    if not winText:
                        if retry:
                            self.share_call_screen(params, False)
                        else:
                            raise AssertionError('The Screen share failed')
        ...
        try:
            if params["join_on"] == "internal_number":
                ...
                if params["joining_device"] == "deskphone":
                    ...
                    # verifies whether the conference is loaded or not
