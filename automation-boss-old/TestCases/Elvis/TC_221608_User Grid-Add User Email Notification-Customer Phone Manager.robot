*** Settings ***
Documentation   BOSS User Grid - Add User Email Notification- Customer Phone Manager
...             dev-Sameena Kauser
...
Initialize Environment
    ...
    Set Suite variable    ${confirmation_for_requestby_pm}       ${values["confirmation_for_requestby_pm"]}
...
TC-221608_User Grid-Add User Email Notification-Customer Phone Manager
    ...
    I fill in ${AddEditpersonWizard} form with ${confirmation_for_requestby_pm}
