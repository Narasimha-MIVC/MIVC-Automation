*** Settings ***
Documentation     MH15_left_click_drag_and_drop_call_in_dialer_search_result
...               HariPrakash
...
*** Test cases ***
MH15_left_click_drag_and_drop_call_in_dialer_search_result
	...
	#UserA drags and drops  UserC to transfer the call
	Place End Call with ${client1} and drag_and_move and blindTransfer
	
	#UserC receives the call from UserB
