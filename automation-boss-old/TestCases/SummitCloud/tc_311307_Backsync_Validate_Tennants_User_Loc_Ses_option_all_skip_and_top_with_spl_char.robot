*** Settings ***
Documentation    BackSync - Validate Tenant,User,Service,Location for option all and skip and top with special char
...
*** Test Cases ***
BackSync - Validate Tenant,User,Service,Location for option all and and skip and top with special char
...
#################################################################################
  ...
  # connect M5DB and fetch data from log_eventpropagation table
   ...
   # fetch the Users data from UC Back Sync -
    ...
    set to dictionary  ${url_info_user1}  option  all
	set to dictionary  ${url_info_user1}  skip  0
	set to dictionary  ${url_info_user1}  top  0
	set to dictionary  ${url_info_user1}  spl_char  @@@@
   ...
   # fetch the location data from UC Back Sync -
    ...
    set to dictionary  ${url_info_loc1}  option  all
	set to dictionary  ${url_info_loc1}  skip  0
	set to dictionary  ${url_info_loc1}  top  0
	set to dictionary  ${url_info_loc1}  spl_char  @@@@
    ...
    set to dictionary  ${url_info_account1}  option  all
	set to dictionary  ${url_info_account1}  skip  0
	set to dictionary  ${url_info_account1}  top  0
	set to dictionary  ${url_info_account1}  spl_char  @@@@
    ...
    set to dictionary  ${url_info_ses1}  option  all
	set to dictionary  ${url_info_ses1}  skip  0
	set to dictionary  ${url_info_ses1}  top  0
	set to dictionary  ${url_info_ses1}  spl_char  @@@@
