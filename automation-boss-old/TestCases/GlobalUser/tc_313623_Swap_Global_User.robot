...
1. Global User : Swap Global User
    ...
    Set to Dictionary    ${globaluser_swap}    requested_by    ${request_by}
    Set to Dictionary    ${globaluser_swap}    request_source    Email
#    And I verify Global Users Products for Swap      &{globaluser_swap}
    And I swap global user     &{globaluser_swap}
