*** Settings ***
Documentation     MH15_conClientLicense_verifyDashbrd_and_contctCardGrp_fro_consultTransfr_fromContctCard
...               HariPrakash
...
*** Test cases ***
MH15_conClientLicense_verifyDashbrd_and_contctCardGrp_fro_consultTransfr_fromContctCard
	...
	Place End Call with ${client1} and consult and ${user03.first_name} ${user03.last_name}
	
	#UserC receives the calll from UserB
	Place End Call with ${client3} and recv and ${EMPTY}
	
	#UserA completes the Consult Transfer
