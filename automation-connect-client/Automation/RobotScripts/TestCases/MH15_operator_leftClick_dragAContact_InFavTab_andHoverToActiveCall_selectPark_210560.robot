*** Settings ***
Documentation     MH15_operator_leftClick_dragAContact_InFavTab_andHoverToActiveCall_selectPark
...               HariPrakash
...
*** Test cases ***
MH15_operator_leftClick_dragAContact_InFavTab_andHoverToActiveCall_selectPark
	...
	Place End Call with ${client1} and drag_and_move and favouriteContactTransferPark
	
    
	#Verify the park call
	...
	#delete the contact from favourites
