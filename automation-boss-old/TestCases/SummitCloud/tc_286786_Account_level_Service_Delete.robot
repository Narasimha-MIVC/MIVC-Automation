*** Settings ***
Documentation    Services Delete - Account level service delete
...
*** Test Cases ***
Services Delete - Account level service delete
    [Tags]    DEBUG
    ...
    # fetch the service data from UC
    # Request Format - "http://default:1234@10.32.128.43:18086/v2/services/services:access:cosmo:telephony"
    &{url_info_1}=  copy dictionary  ${UC_SES_TBL_SERVICES_URL}
    ${condition}=  set variable  services:access:cosmo:telephony/tenants/${data_m5db_accountguid[0]['AccountGuid']}
    set to dictionary  ${url_info_1}  condition  ${condition}
    @{data_uc_closed}=  I fetch data from summit cloud db  &{url_info_1}
    log many  @{data_uc_closed}
