...
Login as DM and Validate error message for saving with already taken extension
    ...
    Set to Dictionary    ${user_ph_setting_Info}    extn    ${user_extn}
    Set to Dictionary    ${user_ph_setting_Info}    error_message    SCA cannot be saved: Profile with extension ${user_extn} already exists
