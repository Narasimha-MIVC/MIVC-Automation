*** Settings ***
Documentation     MH15_Left_click_drag_and_drop_on_an_incomming_call_when_ringing
...               Aakash
...               Comments:
...
*** Test cases ***
MH15_Left_click_drag_and_drop_on_an_incomming_call_when_ringing
    ...
    # search userC in extension
    Show Verify ContactCard with ${client2} and Sdirectory and yes and ${user03.first_name} ${user03.last_name}
    
    #userB called to userA
    Call Contact By Doubleclick with ${client1} and ${user02.first_name} ${user02.last_name}
    
    # userB called to userA
    Place End Call with ${client2} and drag_and_move and blindTransferOnCall
    
    # userC checks incomming call
    Check Incoming Call with ${client3}    
    Place End Call with ${client3} and recv and ${EMPTY}
    
    #check dashboard at userA not have any call and userB, and userC have call
    Check Client Panel with ${client2} and ${EMPTY} and nocall and 1 and ${EMPTY} 
    Check Client Panel with ${client1} and ${user03.first_name} ${user03.last_name} and nocall and 1 and ${EMPTY} 
    Check Client Panel with ${client3} and ${user01.first_name} ${user01.last_name} and nocall and 1 and ${EMPTY} 
