*** Settings ***
Documentation    API to expose Event data - Validation of idms delete sync SC with Filter as all -
...
*** Test Cases ***
API to expose Event data - Validation of idms delete sync SC with Filter as all - Success of EventPropagator-eventpropagator to SC Fails
