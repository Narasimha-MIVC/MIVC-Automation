...
1 Login as staff user and Edit Holiday Schedule - Change Timezone
    ...
    Then In D2 I verify holiday schedule "${HolidayScheduleStaff["scheduleName"]}" with date "${HolidayScheduleStaff["date"]}" and "${HolidayScheduleEdit["timeZone"]}" is set for ${params['partition_id']}
...
2 Login as DM user and Edit Holiday Schedule - Change Timezone
    ...
    Then I verify holidays schedule  &{HolidayScheduleEdit}
    Then In D2 ${D2IP} I login with ${D2User} and ${D2Password}
    Then In D2 I verify holiday schedule "${HolidayScheduleDM["scheduleName"]}" with date "${HolidayScheduleDM["date"]}" and "${HolidayScheduleEdit["timeZone"]}" is set for ${params['partition_id']}
...
3 Login as PM user and Edit Holiday Schedule - Change Timezone
    ...
    Then I verify holidays schedule  &{HolidayScheduleEdit}
    Then In D2 ${D2IP} I login with ${D2User} and ${D2Password}
    Then In D2 I verify holiday schedule "${HolidaySchedulePM["scheduleName"]}" with date "${HolidaySchedulePM["date"]}" and "${HolidayScheduleEdit["timeZone"]}" is set for ${params['partition_id']}
