*** Settings ***
Documentation    Validation of ses sync SC with Filter as Failed - Failure of EventPropagator
...
*** Test Cases ***
Validation of ses sync SC with Filter as Failed - Failure of EventPropagator
