*** Settings ***
Documentation    Event Persistence - Validation of loc logging - Failure of EventPropagator
...
*** Test Cases ***
Event Persistence - Validation of loc logging - Failure of EventPropagator
