*** Settings ***
Documentation   BOSS User Grid -Add User-Set Roles when adding users (Decision Maker)
...             dev-Sameena Kauser
...
TC-221611_User Grid-Add User-Set Roles when adding users (Decision Maker).robot
