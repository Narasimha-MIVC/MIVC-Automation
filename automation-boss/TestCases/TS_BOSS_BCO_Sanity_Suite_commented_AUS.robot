...
#    and I add Partition    &{Partition_US}
#    Then I verify that Partition is set as Primary    &{Partition_US}
#    #And I log off
#
...
60 Login as staff user and delete contract
    Given I login to ${URL} with ${bossUsername} and ${bossPassword}
    and I switch to "switch_account" page
    and I switch to account AutoTest_Acc_to_deleteiajaCnJW with ${AccWithoutLogin} option
#    When I switch to "accounts" page
...
#    When I activate all service
    ...
    And I close contract "AutoTest_Acc_to_deleteiajaCnJW "
    Then I verify contract "AutoTest_Acc_to_deleteiajaCnJW " is deleted
