*** Settings ***
Documentation    Edited Assigned TN from Bridged Call Appearance to Unassign as DM user
...
*** Test Cases ***
Login as DM user and Edit Assigned TN from Bridged Call Appearance to Unassign
