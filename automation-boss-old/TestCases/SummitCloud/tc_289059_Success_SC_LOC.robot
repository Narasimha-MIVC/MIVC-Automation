*** Settings ***
Documentation    Event Persistence - Validation of loc logging - Success of Summit Cloud - LOC
...
*** Test Cases ***
Event Persistence - Validation of loc logging - Success of Summit Cloud - LOC
    [Tags]    DEBUG
