*** Settings ***
Documentation    Validation of idms sync SC with Filter as all - Success of EventPropagator-
...
*** Test Cases ***
Validation of idms sync SC with Filter as all - Success of EventPropagator-eventpropagator to SC Fails
    [Tags]    DEBUG
