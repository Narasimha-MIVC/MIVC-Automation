*** Settings ***
Documentation    Publish Service creation to UC-SES - Add Services through Account Default User
...
*** Test Cases ***
Publish Service creation to UC-SES - Add Services through Account Default User
    [Tags]    DEBUG
