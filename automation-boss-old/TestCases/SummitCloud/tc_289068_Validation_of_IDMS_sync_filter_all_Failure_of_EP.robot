*** Settings ***
Documentation    Validation of idms sync SC with Filter as all- Failure of EventPropagator
...
*** Test Cases ***
Validation of idms sync SC with Filter as all- Failure of EventPropagator
    [Tags]    DEBUG
