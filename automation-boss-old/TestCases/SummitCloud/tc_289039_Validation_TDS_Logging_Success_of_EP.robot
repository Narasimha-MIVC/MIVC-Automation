*** Settings ***
Documentation    Event Persistence - Validation of tds logging - Success of EventPropagator
...
*** Test Cases ***
Event Persistence - Validation of tds logging - Success of EventPropagator
