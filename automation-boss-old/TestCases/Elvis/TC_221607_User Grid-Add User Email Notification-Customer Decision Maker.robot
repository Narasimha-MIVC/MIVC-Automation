*** Settings ***
Documentation   BOSS User Grid - Add User Email Notification- Customer Decision Maker
...             dev-Sameena Kauser
...
TC-221607_User Grid-Add User Email Notification-Customer Decision Maker
