*** Settings ***
Documentation    Validation of ses sync SC with Filter as all - Success of
...              EventPropagator-eventpropagator to SC Success
...
*** Test Cases ***
Validation of ses sync SC with Filter as all - Success of EventPropagator-eventpropagator to SC Success
