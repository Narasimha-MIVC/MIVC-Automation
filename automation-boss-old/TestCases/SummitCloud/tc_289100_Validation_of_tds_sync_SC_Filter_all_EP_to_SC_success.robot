*** Settings ***
Documentation    Validation of tds sync SC with Filter as all - Success of
...
*** Test Cases ***
Validation of tds sync SC with Filter as all - Success of EventPropagator-eventpropagator to SC Success
