...
Initialize Environment
    ...
    Set Suite Variable    ${add_settings}         ${values["add_settings"]}
...
*** Test Cases ***
221538 Geographic Locations - Add Location Notes Commissionable
    ...
    And I fill in ${wizard} form with ${add_main_validate}
    And I click next to move the ${wizard} to settings
    And I fill in ${wizard} form with ${add_settings}
