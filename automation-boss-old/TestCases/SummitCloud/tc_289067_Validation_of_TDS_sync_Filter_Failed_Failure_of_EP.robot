*** Settings ***
Documentation    Validation of tds sync SC with Filter as failed - Failure of EventPropagator
...
*** Test Cases ***
Validation of tds sync SC with Filter as failed - Failure of EventPropagator
