*** Settings ***
Documentation     Login to BOSS portal and Edit Emergency Hunt Group - Edit Group Members - Remove Member
#...               dev-Vasuja
#...               Comments:
...
1 Login as DM and Edit Emergency Hunt Group - Edit Group Members - Remove Member
...
#    And I create geographic location    &{geolocationDetails}
    Set to Dictionary    ${geolocationDetails}    grp_member    ${user_extn}
    ...
    Set to Dictionary    ${EmergencyHG_Edit}    grp_member    Remove
...
2 Login as PM and Edit Emergency Hunt Group - Edit Group Members - Remove Member
    [Tags]    Regression    EHG
...
3 Login as Staff user and Edit Emergency Hunt Group - Edit Group Members - Remove Member
    [Tags]    Regression    EHG
