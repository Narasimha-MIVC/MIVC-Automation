*** Settings ***
Documentation     MH15_operator_leftClick_dragAContactInSmallAview_InGroupTab_andHoverToActiveCall
...               HariPrakash
...
*** Test cases ***
 MH15_operator_leftClick_dragAContactInSmallAview_InGroupTab_andHoverToActiveCall
	...
	Place End Call with ${client1} and drag_and_move and groupConsultTransfer
	
    #USERC answers the call
    Place End Call with ${client3} and recv and ${EMPTY}
	
	#USERA comletes the transfer
    Complete Consult Call with ${client1} and complete_transfer
