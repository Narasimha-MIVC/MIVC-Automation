*** Settings ***
Documentation    Validation of idms  sync SC with Filter as all -
...
*** Test Cases ***
Validation of idms sync SC with Filter as all - Success of EventPropagator-eventpropagator to SC Success
       [Tags]    DEBUG      SC
