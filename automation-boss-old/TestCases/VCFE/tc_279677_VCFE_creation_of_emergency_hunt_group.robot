*** Settings ***
Documentation     Login to BOSS portal and VCFE-Creation of  Emergency Hunt Group
#...               dev-Vasuja
#...               Comments:
...
1 Login as DM and VCFE-Creation of Emergency Hunt Group
...
#    And I create geographic location    &{geolocationDetails}
    ...
    Set to Dictionary    ${geolocationDetails}    tooltip    True
...
2 Login as PM and VCFE-Creation of Emergency Hunt Group
    [Tags]    Regression    EHG
    Given I login to ${URL} with ${bossUsername} and ${bossPassword}
    When I switch to "switch_account" page
    And I switch to account ${SCOCosmoAccount} with ${AccWithoutLogin} option
