*** Settings ***
Documentation    Validation of idms sync SC with Filter as failed - Success of EventPropagator-
...              eventpropagator to SC Fails
...
*** Test Cases ***
Validation of idms sync SC with Filter as failed - Success of EventPropagator-eventpropagator to SC Fails
    [Tags]    DEBUG
...
#    And I compare and varify ${test_data} with ${data_uc_IDMS} for table users
    ...
    # Verify the log in UC-IDMS once IDMS comes UP to check data is pushed through Back Sync
