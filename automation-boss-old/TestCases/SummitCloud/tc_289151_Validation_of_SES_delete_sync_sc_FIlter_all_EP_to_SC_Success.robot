...
*** Test Cases ***
Validation of ses delete sync SC with Filter as all - Success of EventPropagator-eventpropagator to SC Success
 ...
 # fetch the data from UC Back Sync -
    ...
    set to dictionary  ${url_info1}  EndDate  ${data_m5db_EventPropagation[0]['DateModified']}
