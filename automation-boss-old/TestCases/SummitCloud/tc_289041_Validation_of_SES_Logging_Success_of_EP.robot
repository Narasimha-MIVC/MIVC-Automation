*** Settings ***
Documentation    Event Persistence - Validation of ses logging - Success of EventPropagator
...
*** Test Cases ***
Event Persistence - Validation of ses logging - Success of EventPropagator
