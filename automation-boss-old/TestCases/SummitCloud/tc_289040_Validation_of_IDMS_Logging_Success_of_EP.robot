*** Settings ***
Documentation    Event Persistence - Validation of idms logging - Success of EventPropagator
...
*** Test Cases ***
Event Persistence - Validation of idms logging - Success of EventPropagator
