*** Settings ***
Documentation    Validation of tds delete sync SC with Filter as all - Success
...               of EventPropagator - eventpropagator to SC Fail
...
*** Test Cases ***
Validation of tds delete sync SC with Filter as all - Success of EventPropagator - eventpropagator to SC Fail
    ...
    ${query}=  set variable  select * from log_EventPropagation where EntityName='Profile'
    ...
    ${query}=  set variable  select Payload from log_EventPropagation where EntityName='Profile'
