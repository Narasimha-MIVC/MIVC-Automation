...
if __name__ == "__main__":
    ...
    # obj.login(url = "http://portal.sit.shoretel.com/UserAccount/LogOn",UserName="bchin@cosmo.shoretel.com",Password="Shoreadmin1$")
    # obj.login(url = "http://10.197.145.190/UserAccount/LogOn",UserName="staff@shoretel.com",Password="Abc123!!")
    ...
    # obj.switch_account(act_name="Automation New")
    ...
    # obj.configure_prog_button(account_name='Automation New', part_name='BAU',user_email="auser1@shoretel.com",button_box=0,soft_key=1,function="Silent Coach",label="Coach",extension="4001")
    # obj.configure_prog_button(account_name='Automation New', part_name='BAU',user_email="auser3@shoretel.com",button_box=0,soft_key=2,function="Silent Monitor",label="moni",extension="4000")
    ...
    # obj.clear_prog_button(account_name='Not Scale', part_name='SC1',user_email="scaleuser4098@mitel.com",button_box=0,soft_key=1)