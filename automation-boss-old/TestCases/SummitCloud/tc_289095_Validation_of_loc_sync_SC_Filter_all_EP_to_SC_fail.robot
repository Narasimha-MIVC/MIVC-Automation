*** Settings ***
Documentation    Validation of loc sync SC with Filter as all - Success of EventPropagator-
...
*** Test Cases ***
Validation of loc sync SC with Filter as all - Success of EventPropagator-eventpropagator to SC Fails
...
#   # stop container LOC
#    I stop docker container  loc  &{Uc_Details}
#    log many  &{data_uc}
#    sleep  10
