...
*** Test Cases ***
As a staff user verify whether he has access to dial plan and permissions to change and edit Trunk Access Codes in Dial plan.
    ...
    ${DialPlanDict}=  I edit enabled digit from Dial plan    Trunk Access Codes (1 Digit)
