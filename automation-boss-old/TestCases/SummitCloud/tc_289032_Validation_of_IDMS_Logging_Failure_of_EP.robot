*** Settings ***
Documentation    Event Persistence - Validation of idms logging - Failure of EventPropagator
...
*** Test Cases ***
Event Persistence - Validation of idms logging - Failure of EventPropagator
...
#    Set to Dictionary  ${TestUser}    assign_new_number    ${True}
   ...
   # Add user
    ...
    When I connect db  &{log_info_m5db}
    ${query}=  set variable  select * from log_EventPropagation where EntityName='Person'
