*** Settings ***
Documentation    As a DM user verify already assaigned profile should not list in abca profile drop down
...               dev-Vasuja
...
*** Test Cases ***
As a DM user verify already assaigned profile should not list in abca profile drop down
