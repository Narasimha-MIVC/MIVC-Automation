...
${GlobalUserBillingLoc}   Billing_location1
${BROWSER}                chrome  #canary
${runmode}                normal
${SCOCosmoAccount}        Test_automation_Account
...
#Account Detail:
${accountName1}           Test_automation_Account
${DMemail}                dmuser1@auto.com
${DMpassword}             Abc123!!
${PMemail}                pmuser1@auto.com
${PMpassword}             Abc123!!
${PMUser}                 PM User
${username} =             dmuser1@auto.com
...
&{phoneDMUser01}    user_email=dmuser1@auto.com    password=Abc123!!
&{phonePMUser01}    user_email=pmuser1@auto.com   password=Abc123!!
