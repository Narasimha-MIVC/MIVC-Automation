...
Initialize Environment
    ...
    Set Suite Variable    ${update_values2}         ${values["update_values2"]}
...
221550 - Geographic Locations - Edit E911 phone number for location
    ...
    When I filter column headings for ${grid} with LabelFormatted in ${update_values2}
    and I show the context menu for ${grid} with LabelFormatted in ${update_values2}
