...
Four way Blind Conference
    ...
    BuiltIn.sleep   1s
         ...
         Log          STEP - 10: Click on Blind Conference and Add Phone05
    make conference from ${Phone01}
    BuiltIn.sleep   1s
    ...
    Log          STEP - 11: Phone05 Answer the call
    ...
    Log          STEP - 13: Phone01 End the call
    ...
    Log          STEP - 15: Phone01 End the call
