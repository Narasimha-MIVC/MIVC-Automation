*** Settings ***
Documentation    BackSync - Validate Tenant,User,Service,Location for option all and order by descending
...
*** Test Cases ***
BackSync - Validate Tenant,User,Service,Location for option all and order by descending
...
#################################################################################
  ...
  # connect M5DB and fetch data from log_eventpropagation table
   ...
   # fetch the Users data from UC Back Sync -
	...
	set to dictionary  ${url_info_user1}  orderby  desc
   ...
   # fetch the location data from UC Back Sync -
	...
	set to dictionary  ${url_info_loc1}  orderby  desc
	...
	set to dictionary  ${url_info_ses1}  orderby  desc
